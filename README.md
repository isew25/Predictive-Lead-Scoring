...
### Business Goal
X Education needs help in selecting the most promising leads, i.e. the leads that are most likely to convert into paying customers. The company needs a model wherein you a lead score is assigned to each of the leads such that the customers with higher lead score have a higher conversion chance and the customers with lower lead score have a lower conversion chance. 

### Modeling
<img src="./assets/metric table 2.png" width="900">
...
- Lead converted into sales will yield $120 in Revenue.

- Time and efforts spent on chasing leads is $30.
